...
create_users = "CREATE TABLE users (username TEXT PRIMARY KEY, password TEXT NOT NULL, name TEXT NOT NULL, age INTEGER NOT NULL,gender TEXT NOT NULL, prefGender TEXT NOT NULL, lang TEXT NOT NULL, sortAlg TEXT NOT NULL, type TEXT NOT NULL, bitcoin TEXT NOT NULL, nameCase TEXT NOT NULL, braces TEXT NOT NULL, bio TEXT NOT NULL, posMatch TEXT);"

create_personality = "CREATE TABLE personality (username TEXT PRIMARY KEY, open DECIMAL NOT NULL, consc DECIMAL, extra DECIMAL, agree DECIMAL, emotRange DECIMAL);"
